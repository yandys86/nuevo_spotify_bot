...
echo "================================================"
echo "   YiyoLMB - Despliegue Total v5.0 (Final)"
echo "================================================"
...
for VM_ID in $VMS; do
    ...
    echo "[VM $VM_ID] 2. Instalando Librerías (PyAutoGUI)..."
    # Forzamos la instalación de dependencias críticas
